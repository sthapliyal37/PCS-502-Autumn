...
│   └── fork_demo.c
│
├── Week-02-Parent-Child/
│   └── odd_even_sum.c
│
├── Week-03-Wait/
│   └── wait_demo.c
│
├── Week-04-Orphan-Zombie/
│   ├── orphan.c
│   └── zombie.c
│
├── Week-05-Pipe/
...
│   └── reader.c
│
├── Week-07-Message-Queue/
│   ├── sender.c
│   └── receiver.c
│
├── Week-08-Shared-Memory/
│   ├── writer.c
│   └── reader.c
│
├── Week-09-FCFS/
...
│   └── sjf.c
│
├── Week-11-Priority-Scheduling/
│   └── priority.c
│
├── Week-12-FIFO-Page-Replacement/
│   └── fifo_page_replacement.c
│
├── Week-13-LRU-Page-Replacement/
